...
export default function UpdateProduct({product}) {
  ...
  const clickSubmit = (event) => {
    ...
    updateProduct(product.id, item,token )
    // .then((data) => {
      // if (data.error) {
      //   setItem({
      //     ...item,
          ...
          >
            <div style={{ display: "flex", margin: "auto" }}>
              <Form style={{ width: "100%", padding: "2rem" }}>
                <h1 style={{ marginBottom: "4rem", fontFamily: "cursive", textAlign: "center" }}>Update Product</h1>
                ...
                <div style={{ textAlign: "center" }}>
                  <Button variant="success" type="submit" style={{ backgroundColor: "#003566", color: "white", fontWeight: "700", border: "2px " }} 
                  onClick={clickSubmit}
                  >
                    Update
                  </Button>{" "}
